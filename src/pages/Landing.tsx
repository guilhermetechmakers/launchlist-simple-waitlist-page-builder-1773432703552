  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <section
          id="hero"
          className="relative overflow-hidden border-b border-border bg-[#1F2023] px-4 py-16 md:px-6 md:py-24 lg:py-32"
        >
          <div className="mx-auto grid max-w-[1200px] gap-12 lg:grid-cols-2 lg:gap-16">
            <div className="flex flex-col justify-center">
              ...
              <p className="mt-6 max-w-xl text-lg leading-relaxed text-[#9AA0A6]">
            ...
            <div className="flex items-center justify-center rounded-[28px] bg-[#2a2b2e] p-8 shadow-xl">
              <div className="w-full max-w-sm rounded-2xl border border-white/10 bg-card p-6 text-center shadow-card">
                ...
                <div className="mt-4 flex gap-2">
                  <input
                    ...
                    className="input-launchlist w-full"
                    readOnly
                  />
        ...
        <section id="how-it-works" className="border-b border-border bg-background px-4 py-16 md:px-6 md:py-24">
        ...
        <section id="features" className="border-b border-border bg-card px-4 py-16 md:px-6 md:py-24">
          <div className="mx-auto max-w-[1200px]">
            <h2 className="font-heading text-3xl font-bold text-foreground md:text-4xl">
              Built for makers
            </h2>
